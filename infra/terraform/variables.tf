...
variable "bedrock_model_id" {
  description = "Fallback Bedrock model ID (GovCloud: use Claude 3.5 Sonnet v2, 3.7 Sonnet, or Sonnet 4.5)"
  type        = string
...
variable "chatbot_model_id" {
  description = "Bedrock model ID for Jira/Confluence chatbot (GovCloud: use Claude 3.5 Sonnet v2, 3.7 Sonnet, or Sonnet 4.5)"
  type        = string
  default     = "anthropic.claude-3-5-sonnet-20241022-v2:0"
}
